...
#define FILTER_FRIENDLY_NAME        L"ndislwf NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{9d3a9a67-a3bf-4a1e-ac77-8a3b6966914a}" //unique name, quid name
...
extern block_list_t* headRecive;
extern block_list_t* headSend;
...
DRIVER_DISPATCH ndislwfDispatch;

DRIVER_DISPATCH ndislwfDeviceIoControl;
